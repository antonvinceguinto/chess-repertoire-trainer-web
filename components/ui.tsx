...
export function ControlButton({
  ...
  return (
    <button
      type="button"
      className={`inline-flex h-8 min-w-8 items-center justify-center gap-1 rounded-md border border-slate-700 bg-slate-800/80 px-2 text-sm lg:text-[15px] text-slate-200 transition hover:bg-slate-700 disabled:cursor-not-allowed disabled:opacity-35 ${className}`}
      {...props}
    >
      {children}
    </button>
...
export function Button({
  ...
  return (
    <button
      type="button"
      className={`inline-flex items-center justify-center gap-1.5 rounded-md px-3 py-1.5 text-sm lg:text-[15px] font-medium transition disabled:cursor-not-allowed disabled:opacity-40 ${VARIANT[variant]} ${className}`}
      {...props}
    >
      {children}
    </button>
...
export function PanelHeader({
  ...
  return (
    <div className="flex items-center justify-between gap-2 border-b border-slate-800 px-3 py-2">
      <h2 className="text-[13px] lg:text-sm font-semibold uppercase tracking-wide text-slate-400">
        {title}
      </h2>
      {right}
    </div>
...
export function WdlBar({
  ...
  return (
    <div className="flex h-4 w-full overflow-hidden rounded-sm text-[10px] lg:text-[11px] font-semibold leading-4">
      <div
